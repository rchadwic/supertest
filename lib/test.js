...
Test.prototype.end = function(fn) {
  ...
  var end = Request.prototype.end;
    ...
    console.log("REQUEST SUPERTEST")
                      ...
                      console.log("RESPONSE SUPERTEST")
                      console.log("_______________________________________")
                      console.log("HTTP/"+res.res.httpVersion +" "+ res.res.statusCode +" "+ res.res.statusMessage)
                      for(var i in res.res.headers)
                      {
                          console.log(i + ": " +res.res.headers[i])
                      }
